...
module.exports = {
  ...
  MONGO_URI: process.env.MONGO_URI || 'mongodb://localhost:27017/onework-local',
  MONGO_URI_LIMITER: process.env. MONGO_URI_LIMITER || 'mongodb://127.0.0.1:27017/onework-limiter',
